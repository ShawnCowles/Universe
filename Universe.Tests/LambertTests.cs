...
namespace VindemiatrixCollective.Universe.Tests
{
    public class LambertTest
    {
        ...
        public void LambertSingle()
        {
            ...
            Console.WriteLine($"{nameof(LambertSingle)} completed in {Common.timer.ElapsedMilliseconds} ms for {izzo.MaxIterations} iterations");
        }
        ...
        public void LambertMultiple()
        {
            ...
            Console.WriteLine($"{nameof(LambertSingle)} M:{izzo.Revolutions} completed in {Common.timer.ElapsedMilliseconds} ms for {izzo.MaxIterations} iterations");
            ...
            Console.WriteLine($"{nameof(LambertSingle)} M:{izzo.Revolutions} Lowpath: {izzo.LowPath} completed in {Common.timer.ElapsedMilliseconds} ms for {izzo.MaxIterations} iterations");
            Common.timer.Restart();
