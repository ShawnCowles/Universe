...
namespace VindemiatrixCollective.Universe.CelestialMechanics.Manoeuvres
{
    public class IzzoLambertSolver : ILambertSolver
    {
        ...
        /// </summary>
        private (double V_r1, double V_r2, double V_t1, double V_t2) reconstruct(double x, double y, double r1, double r2, double ll, double gamma, double rho, double sigma)
        {
        ...
        private double householder(double p0, double T0, double ll, int M)
        {
            ...
            throw new InvalidOperationException($"Failed to converge after {MaxIterations} iterations using {rtol:E0}");
        }
